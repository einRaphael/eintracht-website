...
const Gallery = () => {
    ...
    useEffect(() => {
        ...
        gsap.set(q(".beschreibung, .news, .image-wrapper, .gallery"), { opacity: 0, y: 20 });
        
        // Staggered animation to visible state
        gsap.to(q(".beschreibung, .news, .image-wrapper, .gallery"), {
            opacity: 1,
            y: 0,
            stagger: 0.1,
            duration: 0.5,
    ...
    return (
        <div ref={galleryRef}>
            <h1 className="news"><i>TOP-NEWS</i></h1>
            <section className="gallery" aria-label="Bildübersicht">
                <a href="news.html" className="gallery-link">
                    <figure>
                        ...
                        <div className="beschreibung-container">
                            <h1 className="beschreibung">Von der Gründung bis zu ersten Deutschen Meisterschaft vergingen 60
                ...
                <a href="beitrag2.html" className="gallery-link">
                    <figure>
                        ...
                        <div className="beschreibung-container">
                            <h1 className="beschreibung">Die Spieltage 28 bis 30 sind zeitgenau terminiert: Köln gastiert
                ...
                <a href="beitrag3.html" className="gallery-link">
                    <figure>
                        ...
                        <div className="beschreibung-container">
                            <h1 className="beschreibung">Am 25. Spieltag trifft die Eintracht auswärts auf den FC St. Pauli. Die
                ...
                <a href="beitrag4.html" className="gallery-link">
                    <figure>
                        ...
                        <div className="beschreibung-container">
                            <h1 className="beschreibung">Die Eintracht besiegt den SC Freiburg mit 2:0 (0:0). Chaibi netzt 44
